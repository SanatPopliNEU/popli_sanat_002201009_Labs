...
public class ViewProductDetailJPanel extends javax.swing.JPanel {
    ...
    public ViewProductDetailJPanel(JPanel workArea, Product product) {
        ...
        if(product.getLogoImage()!=null) imgIcon.setIcon(product.getLogoImage());
      else imgIcon.setText("No Logo");
    ...
    private void btnSaveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSaveActionPerformed
        ...
        JOptionPane.showMessageDialog(this,"Product Information saved","Information",INFORMATION_MESSAGE);
        refreshTable();
    ...
    private void btnAddFeatureActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAddFeatureActionPerformed
        ...
        newFeature.setName("Battery");
        newFeature.setValue("100MAH");
        Feature newFeature1=product.addNewFeature();
        newFeature.setName("RAM");
        newFeature.setValue("2TB");
        Feature newFeature2=product.addNewFeature();
        newFeature.setName("Health");
        newFeature.setValue("fine");
        saveFeatures();
        refreshTable();
    ...
    private void btnRemoveFeatureActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRemoveFeatureActionPerformed
     ...
     if(selectedRow<0){
         JOptionPane.showConfirmDialog(this, "Please select a valid row", "Warning",JOptionPane.WARNING_MESSAGE);
         return;
     }

...
//      masterOrderCatalog = moc;
    ...
    private void initComponents() {
        ...
        Performance.setCursor(new java.awt.Cursor(java.awt.Cursor.DEFAULT_CURSOR));
        ...
        Performance.getAccessibleContext().setAccessibleParent(workArea);
    ...
    private void PerformanceActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_PerformanceActionPerformed
        // TODO add your handling code here:
       ProductReportJPanel prjp = new ProductReportJPanel(workArea, supplier);
    ...
    private void btnSupplierProfileActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSupplierProfileActionPerformed
        ...
        UpdateJPanel prjp = new UpdateJPanel(workArea, supplier);
        workArea.add("UpdateJPanel", prjp);
      CardLayout layout = (CardLayout)workArea.getLayout();
        layout.next(workArea);
